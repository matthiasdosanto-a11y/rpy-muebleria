        ...
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="text-[13px] font-semibold text-foreground hover:text-accent transition-colors uppercase tracking-widest"
              >
                {item.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
                  ...
                  {items.length === 0 ? (
                    ...
                    <>
                      ...
                      <div className="p-4 border-t border-border space-y-3">
                        ...
                        <a
                          href={`${WHATSAPP_LINKS.base}?text=${encodeURIComponent(
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-sm font-semibold text-white hover:bg-[#20BE5C] transition-colors shadow-sm"
            >
