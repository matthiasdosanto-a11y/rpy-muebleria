...
export const Soporte = () => {
    ...
    return (
        <div className="bg-[#f0f2f5] border border-gray-200 rounded-xl shadow-lg h-[calc(100vh-140px)] flex overflow-hidden">
                ...
                <div className="p-4 bg-[#f0f2f5] flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-gray-800 text-sm leading-tight">Lista de Contactos</span>
                        </div>
                    </div>
                    <button
                        onClick={() => setIsSoundEnabled(!isSoundEnabled)}
                        className="p-2 hover:bg-gray-200 rounded-full transition-colors text-gray-600"
                        title={isSoundEnabled ? "Silenciar" : "Activar sonido"}
                    >
            ...
            {/* ÁREA DE CONVERSACIÓN - WhatsApp Style */}
                    ...
                    <>
                        <div className="h-16 px-4 bg-[#f0f2f5] flex items-center justify-between z-10 border-b border-gray-300 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-gray-900 text-[16px] leading-tight">{currentChat.name}</h3>
                        ...
                        <div
                            ref={scrollRef}
                            className="flex-1 p-4 sm:p-8 overflow-y-auto space-y-2 flex flex-col"
                        >
                        ...
                        <div className="p-3 bg-[#f0f2f5] flex items-center gap-2">
                            ...
                            <form onSubmit={handleSend} className="flex-1 flex gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-primary text-white p-2.5 rounded-full hover:bg-primary/90 transition-all shadow-md disabled:bg-gray-400 active:scale-95"
                                >
                                    <Send size={20} />
                                </button>
                            </form>
